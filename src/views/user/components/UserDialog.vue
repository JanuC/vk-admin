    ...
    >
        ...
        <el-collapse v-model="activeCollapse">
          <el-collapse-item title="基础表单" name="basic">
              ...
              <el-col :span="10">
                <el-form-item label="用户名:" prop="username">
                  <el-input
                    ...
                    :disabled="userDialogData.type === 'edit'"
                  ></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="10">
            ...
            <el-row
              ...
              v-if="userDialogData.type === 'create'"
            >
              <el-col :span="10">
                ...
                <el-form-item label="用户头像:" prop="avatar">
                  <el-space>
                    ...
                    >
                      <template #error>
                        <div
                          class="image-slot w-full h-full flex justify-around items-center bg-[var(--el-fill-color-light)]"
                        >
                          <i-ep-picture />
                        </div>
                      </template>
            ...
            <el-form-item prop="roles">
              ...
              >
                <el-checkbox
                  ...
                  :label="item.name"
                  :value="item.id"
                  :disabled="Boolean(item.isCommon)"
                />
              </el-checkbox-group>
            </el-form-item>
          </el-collapse-item>
      ...
      <template #footer>
        ...
        <el-space v-else>
          ...
          <el-button type="primary" @click="handleConifrm(userFormRef)"
            >确认</el-button
          >
        </el-space>
      </template>
